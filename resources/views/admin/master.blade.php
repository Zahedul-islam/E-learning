...
<head>
    ...
    <!-- MetisMenu CSS -->
    <link href="{{ asset('assets/css/admin/metisMenu.min.css') }}" rel="stylesheet">

    <!-- Custom CSS -->
    <link href="{{ asset('assets/css/admin/sb-admin-2.css') }}" rel="stylesheet">
...
<body>
    ...
    <script src="{{ asset('assets/js/admin/metisMenu.min.js') }}"></script>
